...
// global variables
int nx, ny, iteration_batch_size;
int num_threads;
...
void *calculate_new_values(void* thread_id) {
    ...
    for (iter = 0; iter < max_iter; iter++) {
        ...
        // if (batch_iter_count == iteration_batch_size) pthread_barrier_wait(&bar_calc_1);
        pthread_barrier_wait(&bar_calc_1);
...
int main()
{
    ...
    pthread_barrier_destroy(&bar_calc_1);
    pthread_barrier_destroy(&bar_calc_2);
